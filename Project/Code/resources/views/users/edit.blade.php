...
<div class="container">
    <div class="justify-content-center">
        ...
        <div class="card col-8" style="padding: 16px;"">
            ...
            <div class="form-group row">
                <p class="col-sm-3"><b>{{ __('message.email')}}l</b></p>
                <div class="col-sm-8">
                    <input type="text" name="email" value="{{ $user->email }}" class="form-control">
                </div>
            </div>
            <div class="form-group row">
                <p class="col-sm-3"><b>{{ __('message.password')}}</b></p>
                <div class="col-sm-8">
                    <input type="password" name="password" class="form-control">
                </div>
            </div>
            <div class="form-group row">
                <p class="col-sm-3"><b>{{ __('message.conf_password')}}</b></p>
                <div class="col-sm-8">
                    <input type="password" name="password_confirmation" class="form-control">
                </div>
            </div>
            <div class="form-group row">
                <p class="col-sm-3"><b>{{ __('message.role')}}</b></p>
                <div class="col-sm-8">
            ...
            <div class="form-group row">
                <p class="col-sm-3"><b>S{{ __('message.status')}}</b></p>
                <div class="col-sm-8">
            ...
            <div class="form-group row">
                <div class="col-md-6">
                    <p for="category"><b>{{ __('message.department')}}<span class="text-danger">*</span></b></p>
                    <select class="form-control" name="cat" id="cat" style="width: 100%;" required>
                        <option>{{ __('message.select_departments')}}</option>
                ...
                <div class="col-md-6">
                    <p for="category"><b>{{ __('message.program')}}<span class="text-danger">*</span></b></p>
            ...
            <a class="btn btn-light mt-5" href="{{ route('users.index') }}">{{ __('message.cancel')}}</a>
            {!! Form::close() !!}
        </div>
    </div>
</div>
